...
/// Group 32 parameters per tile: scalar fields remain coalesced across a
/// warp, and fixed column offsets avoid keeping dozens of column pointers
/// live while materializing a parameter.
template <typename algebra_t>
using soa_bound_track_parameters_layout =
    tiled_soa_layout<32, detray::dscalar<algebra_t>[6],
                     detray::dscalar<algebra_t>[36],
